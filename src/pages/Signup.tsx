...
export default function Signup() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    setLoading(true);
    const { error, alreadyExists } = await signUp(email, password, displayName || undefined);
    setLoading(false);
    if (error) {
      ...
      toast({
        ...
        description: "We've sent a verification link to your email. Please confirm it before logging in.",
        duration: 10000,
      });
      navigate("/login");
    }
    ...
    <div className="flex min-h-screen items-center justify-center px-4">
      <Card className="w-full max-w-sm shadow-lg">
        <CardHeader className="text-center">
          ...
          <CardDescription>Start exploring your data with voice</CardDescription>
        </CardHeader>
